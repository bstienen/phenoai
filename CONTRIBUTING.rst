...
1. use the search functionality `here <https://github.com//phenoai/issues>`__ to see if someone already filed the same issue;
...
7. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the PhenoAI repository on GitHub;
